...
//
// Every delivery carries an `X-KK-WABA-Signature` header so receivers
// can verify the request really came from KK WABA and wasn't tampered
// with or replayed. The scheme is Stripe-style:
//
//   X-KK-WABA-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-KK-WABA-Signature` header value for `rawBody`, signed
...
/**
 * Verify a signature header. Exposed so a KK WABA integration
