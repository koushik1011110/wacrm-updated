...
//
// Why the `kkwaba_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     a KK WABA key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for a `kkwaba_test_` variant if
...
export const API_KEY_PREFIX = 'kkwaba_live_';
